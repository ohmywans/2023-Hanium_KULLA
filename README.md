...
안녕하세요. 2023년 한이음 ICT공모전에서 한국정보산업연합회장상을 수상한 Team KULLA 입니다.

다수의 경유지를 두고 ALB(Autonomous Logistics roBot)은 사용자의 호출 순서에 따라 다음 목적지를 선택하기도 하고, 현 위치로부터 가장 가까운 위치의 
