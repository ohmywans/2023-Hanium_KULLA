/********************************************************************************
** Form generated from reading UI file 'give_take.ui'
**
...
#ifndef UI_GIVE_TAKE_H
#define UI_GIVE_TAKE_H
...
public:
    ...
    void setupUi(QMainWindow *give_take)
    {
        if (give_take->objectName().isEmpty())
            give_take->setObjectName(QString::fromUtf8("give_take"));
        give_take->resize(1024, 600);
        centralWidget = new QWidget(give_take);
...
"font: 75 27pt \"Ubuntu Mono\";"));
        ...
        give_take->setCentralWidget(centralWidget);
        menuBar = new QMenuBar(give_take);
        menuBar->setObjectName(QString::fromUtf8("menuBar"));
        menuBar->setGeometry(QRect(0, 0, 1024, 31));
        give_take->setMenuBar(menuBar);
        mainToolBar = new QToolBar(give_take);
        mainToolBar->setObjectName(QString::fromUtf8("mainToolBar"));
        give_take->addToolBar(Qt::TopToolBarArea, mainToolBar);
        statusBar = new QStatusBar(give_take);
        statusBar->setObjectName(QString::fromUtf8("statusBar"));
        give_take->setStatusBar(statusBar);

        retranslateUi(give_take);

        QMetaObject::connectSlotsByName(give_take);
    } // setupUi

    void retranslateUi(QMainWindow *give_take)
    {
        give_take->setWindowTitle(QApplication::translate("give_take", "give_take", 0, QApplication::UnicodeUTF8));
        label_pw->setText(QApplication::translate("give_take", "Password", 0, QApplication::UnicodeUTF8));
        label_mode->setText(QApplication::translate("give_take", "Mode", 0, QApplication::UnicodeUTF8));
        label_mode2->setText(QApplication::translate("give_take", "Mode", 0, QApplication::UnicodeUTF8));
        Button_give->setText(QApplication::translate("give_take", "Give", 0, QApplication::UnicodeUTF8));
        Button_take->setText(QApplication::translate("give_take", "Take", 0, QApplication::UnicodeUTF8));
        Button_rm->setText(QApplication::translate("give_take", "C", 0, QApplication::UnicodeUTF8));
        Button_0->setText(QApplication::translate("give_take", "0", 0, QApplication::UnicodeUTF8));
        Button_5->setText(QApplication::translate("give_take", "5", 0, QApplication::UnicodeUTF8));
        Button_2->setText(QApplication::translate("give_take", "2", 0, QApplication::UnicodeUTF8));
        Button_3->setText(QApplication::translate("give_take", "3", 0, QApplication::UnicodeUTF8));
        Button_7->setText(QApplication::translate("give_take", "7", 0, QApplication::UnicodeUTF8));
        Button_6->setText(QApplication::translate("give_take", "6", 0, QApplication::UnicodeUTF8));
        Button_1->setText(QApplication::translate("give_take", "1", 0, QApplication::UnicodeUTF8));
        Button_8->setText(QApplication::translate("give_take", "8", 0, QApplication::UnicodeUTF8));
        Button_9->setText(QApplication::translate("give_take", "9", 0, QApplication::UnicodeUTF8));
        Button_4->setText(QApplication::translate("give_take", "4", 0, QApplication::UnicodeUTF8));
        Button_Ent->setText(QApplication::translate("give_take", "Enter", 0, QApplication::UnicodeUTF8));
        label_pw2->setText(QApplication::translate("give_take", "Password", 0, QApplication::UnicodeUTF8));
    } // retranslateUi

};

namespace Ui {
    class give_take: public Ui_give_take {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_GIVE_TAKE_H
