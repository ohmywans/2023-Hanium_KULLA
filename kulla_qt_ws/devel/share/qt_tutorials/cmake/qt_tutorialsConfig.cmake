...
if("TRUE" STREQUAL "TRUE")
  set(qt_tutorials_SOURCE_PREFIX /home/jetson/kulla_qt_ws/src/qt_ros/qt_tutorials)
  set(qt_tutorials_DEVEL_PREFIX /home/jetson/kulla_qt_ws/devel)
  ...
  set(qt_tutorials_INSTALL_PREFIX /home/jetson/kulla_qt_ws/install)
...
if(NOT "/home/jetson/kulla_qt_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'qt_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jetson/kulla_qt_ws/src/qt_ros/qt_tutorials/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT qt_tutorials_NUM_DUMMY_TARGETS)
      set(qt_tutorials_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::qt_tutorials::wrapped-linker-option${qt_tutorials_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR qt_tutorials_NUM_DUMMY_TARGETS "${qt_tutorials_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::qt_tutorials::wrapped-linker-option${qt_tutorials_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND qt_tutorials_LIBRARIES "${interface_target_name}")
