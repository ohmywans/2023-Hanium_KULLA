...
(cl:defmethod cl:initialize-instance :after ((m <TaskCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TaskCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name give_one-msg:<TaskCommand> is deprecated: use give_one-msg:TaskCommand instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <TaskCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader give_one-msg:header-val is deprecated.  Use give_one-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'pushcheck-val :lambda-list '(m))
(cl:defmethod pushcheck-val ((m <TaskCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader give_one-msg:pushcheck-val is deprecated.  Use give_one-msg:pushcheck instead.")
  (pushcheck m))
