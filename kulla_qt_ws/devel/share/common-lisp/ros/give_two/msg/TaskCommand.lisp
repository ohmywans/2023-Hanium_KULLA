...
(cl:defmethod cl:initialize-instance :after ((m <TaskCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TaskCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name give_two-msg:<TaskCommand> is deprecated: use give_two-msg:TaskCommand instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <TaskCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader give_two-msg:header-val is deprecated.  Use give_two-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'pushcheck-val :lambda-list '(m))
(cl:defmethod pushcheck-val ((m <TaskCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader give_two-msg:pushcheck-val is deprecated.  Use give_two-msg:pushcheck instead.")
  (pushcheck m))
